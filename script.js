var canvas,
    ...
    obstaculos = {
        ...
        cores: ["#0008ff", "#ff0000", "#17e317", "#ff0066", "#ff6f00"],
        tempoInsere: 0,
        ...
        insere: function () {
            ...
            this.tempoInsere = 20 + Math.floor(100 * Math.random());
        },
    ...
    main(alert("I hope you enjoy it"));